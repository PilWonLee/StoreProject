...
public class apiDTO {
	...
	public void setImportantStoreCnt(String importantStoreCnt) {
		this.importantStoreCnt = importantStoreCnt;
	}

	public String getImportantStoreCnt2() {
		return importantStoreCnt2;
	}

	public void setImportantStoreCnt2(String importantStoreCnt2) {
		this.importantStoreCnt2 = importantStoreCnt2;
	}
