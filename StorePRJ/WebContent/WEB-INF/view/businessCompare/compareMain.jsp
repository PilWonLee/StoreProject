...
<script>
	$(function() {
		$('h1.site-heading.text-center.text-white.d-none.d-lg-block').click(
				function() {
					location.href = 'main.do';
				});
		$('h1.site-heading.text-center.text-white.d-none.d-lg-block > span')
...
<script>
									...
									success : function(data) {
										...
										$
												.each(
														data,
														function(key, value) {
															contents += "<a class='dropdown-item' href='#' id='"+value.indsLclsCd+"'>"
																	+ value.indsLclsNm
																	+ "</a> ";
														});
	...
	function addClickEventBigInds() {
		$('#selectBigIndsDrop').children('.dropdown-item').click(
				function(event) {
	...
	function addClickEventMidInds() {
		$('#selectMidIndsDrop').children('.dropdown-item').click(
				function(event) {
					event.preventDefault();//a태그 href 막음
...
<body>
	...
	<form id="transPage">
		<input type="hidden" name="cx" id="cxId" value=""> <input type="hidden" name="cy" id="cyId" value=""> <input type="hidden" name="radius" id="radiusId" value=""> <input type="hidden" name="locName" id="locNameId"
			value=""> <input type="hidden" name="midCd" id="midCd" value="">
	</form>
	...
	<div class="container">
		<div class="intro">
			...
			<div style="margin-top: 5%">
				<div class="card border-primary mb-3" id="selectNationDiv" style="max-width: 20rem; max-height: 150px; width: 300px">
					...
					<div class="card-body">
						...
						<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
							...
							<div class="btn-group" role="group">
								<button type="button" id="selectNationBtn" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
								<!-- 드랍다운 부분 -->
								<div class="dropdown-menu" aria-labelledby="btnGroupDrop3" x-placement="bottom-start" id="selectNationDrop" style="position: absolute; transform: translate3d(0px, 36px, 0px); top: 0px; left: 0px; will-change: transform;"></div>
							</div>
						</div>
						<br>
						<!-- 시,군,구 선택 셀렉트 박스 -->
						<div class="btn-group" role="group" id="selectCityDiv" aria-label="Button group with nested dropdown" style="padding-top: 5px">
							...
							<div class="btn-group" role="group">
								...
								<!-- 드랍다운 부분 -->
								<div class="dropdown-menu" aria-labelledby="btnGroupDrop3" x-placement="bottom-start" id="selectCityDrop" style="position: absolute; transform: translate3d(0px, 36px, 0px); top: 0px; left: 0px; will-change: transform;"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div style="margin-top: 5%;">
				<div class="card border-primary mb-3" style="margin-left: 10%; width: 800px; height: 500px">
	...
	<div style="text-align: center; margin-top: 3%">
		<button type="button" class="btn btn-info" id="startAnalysis" style="width: 350px; height: 50px">
			<h3>상권 비교</h3>
		</button>
	</div>
