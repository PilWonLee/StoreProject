...
<div style="text-align: right">
	...
	<div style="display: inline">
		...
		<h1 class="site-heading text-center text-white d-none d-lg-block"  
			...
			<span class="site-heading-upper text-primary mb-3" style="color:#2C3E50 !important">우리동네 상권 분석</span>
			<span class="site-heading-lower" style="color:black">Business Analysis</span>
		</h1>
	</div>